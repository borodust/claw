...
(defvar *funciton-class-table* (make-hash-table))
    ...
    (let (doc
      ...
      (let* ((arg-types (append
        ...
        `(progn
           ...
           (cffi:defcfun (,mangled ,cfun-name ,@(nreverse cffi-opts)) ,return-type ,@configuration)
           (meta-eval
...
(defun register-intricate-function-class (name data)
  (setf (gethash name *funciton-class-table*) data))


(defun find-intricate-function-class (name)
  (gethash name *funciton-class-table*))
